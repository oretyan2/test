...
Editor](https://codeberg.org/fieryhenry/BCSFE-Python).
...
Details about what each color is used for can be found [here](https://codeberg.org/fieryhenry/ExampleEditorTheme#themejson-file)
